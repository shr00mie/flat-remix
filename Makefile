...
generate_theme_variants:
	find . -name "Flat-Remix-*-Dark" ! -name Flat-Remix-Black-Dark -exec sh -c 'mv $$1/places/scalable $$1/.places; rm -rf $$1/*/; cp -a Flat-Remix-Black-Dark/* $$1; rm -rf $$1/places/scalable; mv $$1/.places $$1/places/scalable ' _ {} \;
